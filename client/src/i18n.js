(function (global) {
  ...
  const EN = Object.freeze({
    ...
    "Etkinlik":"Events",
    "ETKİNLİK":"EVENTS",
    "DEVRE PAZARI":"CIRCUIT MARKET",
    "Hediye Sandıklar":"Gift Chests",
    "ÜCRETSİZ KAZANIM":"FREE REWARDS",
    ...
    "Destek":"Support",
    "Sabotaj":"Sabotage",
    "AKTİF SAVAŞ DESTESİ":"ACTIVE BATTLE DECK",
    "DÜZENLE":"EDIT",
    "SAVAŞ":"BATTLE",
    "Eşleştirmeyi başlat":"Start matchmaking",
    "Bilgi":"Info",
    "Seç":"Select",
    "Yükselt":"Upgrade",
    "DESTEDE":"IN DECK",
    "DESTE DIŞI":"NOT IN DECK",
    "Genel Bakış":"Overview",
    "Yetenek Ağacı":"Talent Tree",
    "Modül Hakkında":"About Module",
    "Takım merkezi hazırlanıyor":"Team hub is being prepared",
    "CANLI PROGRAM":"LIVE PROGRAM",
    "Günlük":"Daily",
    "Sezon":"Season",
    ...
    "Başlangıç Devresi · 2 Sabit":"Starting Circuit · 2 Fixed",
    "Çekirdek ve Jeneratör sabit başlar":"Core and Generator start fixed",
    ...
    "Henüz hazır deste yok. 6/6 seçim yaptıktan sonra ilk desteni kaydet.":"No saved deck yet. Complete a 6/6 selection to save your first deck.",
    ...
    "Kaydetmek için deste 6/6 olmalı.":"The deck must be 6/6 before saving.",
    ...
    "Seçilen Deste":"Selected Deck",
    "6 farklı kart seç. Savaşta her kartı birden fazla kez üretebilirsin.":"Choose 6 different cards. You can deploy each card more than once during battle.",
    "Deste kartına tıkla; sunucu uygun hücreye otomatik yerleştirsin.":"Tap a deck card and the server will place it in a valid cell.",
    "Çekirdek sabit başlar; diğer modülleri sistem uygun boş hücrelere otomatik yerleştirir":"The Core starts fixed; the system automatically places other modules in eligible empty cells",
    "Deste Devre Kredisine göre aktif":"The deck is enabled by Circuit Credits",
    ...
    "Modül kartına dokun; sistem uygun hücreye otomatik yerleştirir.":"Tap a module card; the system places it automatically in an eligible cell.",
    ...
    "Aynı dokun-seç/yerleştir akışı masaüstü ve mobilde kullanılır.":"The same tap-select/place flow is used on desktop and mobile.",
    "Tamamla":"Finish",
