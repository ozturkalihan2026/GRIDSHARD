...

{
  ...
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır"));
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha32->33 protocol status
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha33 protocol
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha34 websocket
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha35 gateway
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha36 setup
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha37 lobby
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha38 runner
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha39 heartbeat
}

{
  const fs=require("fs");
  const src=fs.readFileSync("./src/app.js","utf8");
  assert.ok(src.includes("Test koşuları teknik huni karşılaştırması hazır")); // alpha40 online pvp
}
...
Promise.all(asyncTests).then(() => {
  console.log("129 client tests passed");
}).catch((error) => {
  console.error(error);
  process.exitCode = 1;
});
