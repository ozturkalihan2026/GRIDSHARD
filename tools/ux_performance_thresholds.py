...
def main():
    ...
    if matrix.get('status')!='MEASURED':
        payload={'version':'2.0.0-beta.32','status':'NOT_MEASURED','performance_pass':None,'reason':'Gerçek PASSED browser UX matrisi yok; performans sonucu üretilmedi.','observation_bands':BANDS,'categories':{},'trend':'NOT_AVAILABLE'}
