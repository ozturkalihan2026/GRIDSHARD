...
set "GRIDSHARD_EXPECTED_VERSION=2.0.0-beta.26"
...
rem Boylece eski bir GRIDSHARD surumu 8000'de acik kalsa bile Beta.26 ona baglanmaz.
...
echo [GRIDSHARD] Beta.26 test portu: %GRIDSHARD_WEB_PORT%
start "GRIDSHARD Web Test Sunucusu" cmd /k call "%~dp0BASLAT_WEB_TEST.bat"

rem Tarayiciyi yalnizca secilen port gercekten Beta.26 /health yaniti verirse ac.
...
echo Tarayici dogrulanmis Beta.26 sunucusunda acildi: http://127.0.0.1:%GRIDSHARD_WEB_PORT%/
