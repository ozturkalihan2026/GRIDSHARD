...
set "GRIDSHARD_EXPECTED_VERSION=2.1.0-beta.43"
...
rem Boylece eski bir GRIDSHARD surumu 8000'de acik kalsa bile bu paket ona baglanmaz.
...
echo [GRIDSHARD] %GRIDSHARD_EXPECTED_VERSION% test portu: %GRIDSHARD_WEB_PORT%
start "GRIDSHARD Web Test Sunucusu" cmd /k call "%~dp0BASLAT_WEB_TEST.bat"

rem Tarayiciyi yalnizca secilen port gercekten beklenen /health yaniti verirse ac.
